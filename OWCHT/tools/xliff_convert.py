...
檔案位置：
  - OWCHT/Translation_Text/translation.xliff        （Mode 1 生成，memoQ 匯入用）
  - OWCHT/Translation_Text/translation_zho-TW.xliff （memoQ 匯出，放這裡）
  - OWCHT/Translation_Text/translation.txt          （Mode 2 生成，repo 版本）
